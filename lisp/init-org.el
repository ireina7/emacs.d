...
;; Unfortunately, normal emacs for macOS(mine) do not support svg format:(
;; It seems I need to install a new binary emacs with svg support...
;; But currently I do not want to reinstall my emacs, thus I comment this line of code(i.e. we only support png)
